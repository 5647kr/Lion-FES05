...
console.log(text1.slice(1, 3)); // 1부터 시작해서 3전에 잘린다. start, end(-1)
...
console.log(text2.substring(2, -3)); // -3을 0으로 인식한다. 즉(2, 0)와 마찬가지이다.
...
console.log(text8.replaceAll(" ", "")); // 이렇게 쓰지 말것 hello 와 world사이 띄어쓰기도 삭제해버림
