...
//* slice(start, end): 자르지만 원본은 살아 있다. end는 하나 전까지 자른다. 인덱스값이다.
...
console.log("==========Array 0~99 1==========");

// 실무에서 사용하지 않는 코드
const arr8 = Array(10).fill(0);
// 0이 100개 생성됨
console.log(arr8);
...
console.log("==========Array 1~100 2==========");

const arr12 = Array(10).fill(0);
// 0이 100개 생성됨
const arr13 = [];
//  화살표 함수사용
...
const arr22 = Array(10).fill(0);
function hojun(v, i) {
  return i
};
console.log(arr22.map(hojun));

console.log("==========Array map 6==========");

const arr24 = Array(10).fill(0);
const arr25 = arr24.map((v, i) => {
  return i
});
console.log(arr25);

console.log("==========Array slice 실무팁 1==========");
